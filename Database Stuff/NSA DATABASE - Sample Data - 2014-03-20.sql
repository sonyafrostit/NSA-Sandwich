...
INSERT INTO `orderitemcomponents` (`orderitemid`, `storeid`, `component`) VALUES (3,1,3),(3,1,6),(3,1,10),(5,1,1),(5,1,9),(5,1,10),(6,1,2),(6,1,5),(6,1,7),(7,1,10);

INSERT INTO `orderitemremoved` (`orderitemid`, `storeid`, `componentremoved`) VALUES (1,1,4),(1,1,5),(4,1,8),(7,1,9);

INSERT INTO `orderitems` (`orderitemid`, `storeid`, `orderid`, `menuitemid`, `name`, `price`, `refunded`) VALUES (1,1,5,1,'Ruben',9.99,0),(2,1,5,2,'PBJ',9.99,0),(3,1,6,0,'Custom',9.99,0),(4,1,7,2,'PBJ',9.99,0),(5,1,7,0,'Custom',9.99,0),(6,1,8,0,'Custom',9.99,0),(7,1,8,2,'PBJ',9.99,0);
